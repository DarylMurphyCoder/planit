# PlanIt! User Stories for GitHub Issues
...
- **Title:** Create Tasks
- **Label:** must-have
- **Body:** As a user, I want to create a new to-do item with a title so that I can add tasks to my list.
- **Acceptance Criteria:**
...
- **Title:** View Tasks
- **Label:** must-have
- **Body:** As a user, I want to see all my to-do items so that I can track what needs to be done.
- **Acceptance Criteria:**
...
- **Title:** Update Tasks
- **Label:** must-have
- **Body:** As a user, I want to edit task titles and descriptions so that I can modify tasks if needed.
- **Acceptance Criteria:**
...
- **Title:** Delete Tasks
- **Label:** must-have
- **Body:** As a user, I want to remove completed or unwanted tasks so that I can keep my list clean.
- **Acceptance Criteria:**
...
- **Label:** must-have
- **Body:** As a user, I want to create an account and log in so that my tasks are private and persistent.
- **Acceptance Criteria:**
...
- **Title:** Basic UI
- **Label:** must-have
- **Body:** As a user, I want a simple, intuitive interface so that I can easily manage my tasks.
- **Acceptance Criteria:**
...
- **Label:** should-have
- **Body:** As a user, I want to mark tasks as complete/incomplete so that I can track progress.
- **Acceptance Criteria:**
...
- **Label:** should-have
- **Body:** As a user, I want to set due dates on tasks so that I know deadlines.
- **Acceptance Criteria:**
...
- **Label:** should-have
- **Body:** As a user, I want to organize tasks into categories so that I can group related items.
- **Acceptance Criteria:**
...
- **Label:** should-have
- **Body:** As a user, I want to search or filter tasks by status or category so that I can find specific items quickly.
- **Acceptance Criteria:**
...
- **Label:** should-have
- **Body:** As a user, I want to set priority levels (high, medium, low) so that I focus on important tasks first.
- **Acceptance Criteria:**
...
- **Title:** Task Notes
- **Label:** could-have
- **Body:** As a user, I want to add detailed notes to tasks so that I can include additional context.
- **Acceptance Criteria:**
...
- **Label:** could-have
- **Body:** As a user, I want to set tasks to repeat daily/weekly/monthly so that I don't have to recreate them.
- **Acceptance Criteria:**
...
- **Title:** Task Sharing
- **Label:** could-have
- **Body:** As a user, I want to share task lists with others so that we can collaborate.
- **Acceptance Criteria:**
...
- **Title:** Dark Mode
- **Label:** could-have
- **Body:** As a user, I want a dark theme option so that I can reduce eye strain.
- **Acceptance Criteria:**
...
- **Label:** could-have
- **Body:** As a user, I want to receive email reminders about due tasks so that I don't miss deadlines.
- **Acceptance Criteria:**
  - [ ] User can enable/disable email notifications in settings
  - [ ] Email is sent 24 hours before a task is due
  - [ ] Email is sent on the day a task is due
  - [ ] Emails are sent for overdue tasks
  - [ ] Email contains task title, due date, and link to task
  - [ ] User can configure notification frequency (daily, weekly, etc.)
  - [ ] Notifications respect user's timezone for scheduling
